...
import { Card, Col, Row, Button, InputGroup, Form, Carousel, Container } from 'react-bootstrap'
        ...
        <Container>
            <Row>
                ...
                <Col>
                    ...
                    <h3 style={{display: "flex", justifyContent: "center", color: "paleturquoise"}}>{productDetail?.title}</h3>
                    ...
                    <div style={{ display: 'flex', justifyContent: "space-between" }}>
                        ...
                        <div>
                            <InputGroup className="mb-3">
                                <Form.Control
                                    style={{background: "white", border: "1px solid paleturquoise"}}
                ...
                </div>
                {
                    suggestedProducts.map(products => (
                        <Col key={products.id} >
                            <Card style={{ padding: "5px", paddingTop: "15px", boxShadow: "0 2px 8px 0 paleturquoise", marginTop: "50px" }} >
                                    ...
                                    <Card.Body style={{ borderTop: "1px solid black", marginTop: "10px" }}>
                                        ...
                                        <div>
                                            ...
                                            <div style={{ display: 'flex', justifyContent: "space-between", marginTop: "20px" }}>
                                                <small>Price: <br /> ${Math.round(products.price)}</small>
                                                <Button variant="outline-success" style={{ width: "10px", display: "flex", justifyContent: "center", height: "45px"}}><i style={{ fontSize: "20px" }} className="fa-solid fa-cart-plus"></i></Button>
                                            </div>
